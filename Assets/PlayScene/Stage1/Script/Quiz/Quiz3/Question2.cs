...
public class Question2 : MonoBehaviour
{
    ...
    private QuizManager2.QuestionAnswerPair currentQuestion;
    ...
    void Start()
    {
        ...
        currentQuestion = quizManager.GetCurrentQuestion2();  // 現在の問題と解答のペアを取得
    }
    ...
    public bool CheckAnswer2(GameObject item)
    {
        if (item != null)
        {
            // アイテムのレイヤーとタグのデバッグ出力
