...
{
    private QuizManager2 quizManager2;
    ...
    void Start()
    {
        quizManager2 = FindObjectOfType<QuizManager2>();
    ...
    {
        // 現在の問題を取得
        QuizManager2.QuestionAnswerPair currentQuestion = quizManager2.GetCurrentQuestion2();
