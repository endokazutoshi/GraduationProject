...
public class Question1 : MonoBehaviour
{
    ...
    private QuizManager1.QuestionAnswerPair currentQuestion;
    ...
    void Start()
    {
        ...
        currentQuestion = quizManager.GetCurrentQuestion1();  // 現在の問題と解答のペアを取得
    }
    ...
    public bool CheckAnswer1(GameObject item)
    {
        if (item != null)
        {
            // アイテムのレイヤーとタグのデバッグ出力
